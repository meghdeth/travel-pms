        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Curated selection of premium hotels and accommodations</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Guaranteed lowest prices with no hidden fees</p>
            </div>
            <div className="text-center">
